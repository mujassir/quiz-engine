...
using QuizEngine.Core.Mappings;
...
namespace QuizEngine.Extensions;
...
public static class ServiceExtension
{
    ...
    public static void ConfigureSqlContext(this IServiceCollection services, IConfiguration configuration) =>
        services.AddDbContext<RepositoryContext>(
            opts => opts.UseSqlServer(configuration.GetConnectionString("sqlConnection"),
                b => b.MigrationsAssembly("QuizEngine.Repo")));
    ...
    public static void ConfigureMapping(this IServiceCollection services)
    {
        ...
        {
            map.AddProfile<QuizMappingProfile>();
    ...
    public static void ConfigureSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(c =>
        {
            c.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "Quiz Engine API Services.",
